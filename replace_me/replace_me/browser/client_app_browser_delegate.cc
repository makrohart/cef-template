...
#include "replace_me/browser/client_app_browser_delegate.h"

#include "include/base/cef_logging.h"
#include "include/cef_command_line.h"
#include "include/cef_crash_util.h"
#include "include/cef_file_util.h"
#include "replace_me/browser/client_prefs.h"
#include "replace_me/browser/default_client_handler.h"
...
namespace client::browser {
    ...
    void ClientBrowserDelegate::OnRegisterCustomPreferences(CefRefPtr<client::ClientAppBrowser> app, cef_preferences_type_t type, CefRawPtr<CefPreferenceRegistrar> registrar)
    {
    ...
    void ClientBrowserDelegate::OnBeforeCommandLineProcessing(CefRefPtr<ClientAppBrowser> app, CefRefPtr<CefCommandLine> command_line)
    {
    ...
    bool ClientBrowserDelegate::OnAlreadyRunningAppRelaunch(CefRefPtr<ClientAppBrowser> app, CefRefPtr<CefCommandLine> command_line, const CefString& current_directory)
    {
    ...
    CefRefPtr<CefClient> ClientBrowserDelegate::GetDefaultClient(CefRefPtr<ClientAppBrowser> app)
    {
