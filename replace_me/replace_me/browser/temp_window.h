...
#include "replace_me/browser/client_types.h"

#if defined(OS_WIN)
#include "replace_me/browser/temp_window_win.h"
#elif defined(OS_LINUX)
#include "replace_me/browser/temp_window_x11.h"
#elif defined(OS_MAC)
#include "replace_me/browser/temp_window_mac.h"
#endif
