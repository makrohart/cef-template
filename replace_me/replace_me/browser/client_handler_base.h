...
class ClientHandlerBase : public CefClient,
 ...
 public:
  ...
  static CefRefPtr<ClientHandlerBase> GetForBrowser(
      CefRefPtr<CefBrowser> browser);

  // Returns the BaseClientHandler for |client|.
  static CefRefPtr<ClientHandlerBase> GetForClient(CefRefPtr<CefClient> client);
 ...
 private:
  ...
  DISALLOW_COPY_AND_ASSIGN(ClientHandlerBase);
};
