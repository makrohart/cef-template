...
#include "replace_me/browser/root_window_win.h"
...
#include "replace_me/browser/browser_window_osr_win.h"
#include "replace_me/browser/browser_window_std_win.h"
...
#include "replace_me/browser/temp_window.h"
...
void RootWindowWin::OnSetFullscreen(bool fullscreen) {
  REQUIRE_MAIN_THREAD();
  // Fullscreen handling removed (test code)
}
